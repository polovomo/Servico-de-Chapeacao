 ...
 */
public class OsControllerPecas {
    public boolean inserir(OrdemServicoPecas os) {
        String sql = "INSERT INTO ordem_servico_pecas (id_ordem_servico, id_peca) VALUES (?,?)";
